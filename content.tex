...
give gradual types a semantics in terms of pre-existing static types.
...
We establish noninterference for the gradual language,
called λfSEC
...
Chalice, a verication methodology based on implicit dynamic frames
