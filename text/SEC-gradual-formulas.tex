...
\begin{definition}[Concretization]~\\
    ...
    \end{align*}
\end{definition}
% TODO: reiterate if restriction of codomain to SatFormula (and stupid singleton mapping) is really necessary

Static formula are mapped to a singleton set containing just them.
