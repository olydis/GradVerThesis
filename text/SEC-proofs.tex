...
\begin{proof}[Proof of Lemma \ref{lemma:ol-impl}]~\\
    Goal:
...
\begin{proof}[Proof of Lemma \ref{ex:opt-lift-evalphi}]~\\
    Goal:
...
\begin{proof}[Proof of Lemma \ref{lemma:pred-lift-comp}]~
    \begin{description}
        \item[Introduction] 
        \begin{align*}
...
\begin{proof}[Proof of Lemma \ref{lemma:sl-conj-pred}]
    \begin{description}
        \item[Introduction] 
        \begin{align*}
        &(P \wedge Q)(\phi)\\
...
\begin{proof}[Proof of Lemma \ref{lemma:sl-disj-pred}]
    \begin{align*}
...
\begin{proof}[Proof of Lemma \ref{lemma:eq-fun-lift-agt}]~
    \begin{description}
...
\begin{proof}[Proof of Lemma \ref{lemma:sl-comp}]~
    \begin{description}
        \item[Introduction]
        \begin{align*}
        &g(f(\phi))\\
...
\begin{proof}[Proof of Lemma \ref{lem:comp-gtHoare}]~\\
    Analogous to proof of lemma \ref{lem:comp-tHoare}.
\end{proof}

\begin{proof}[Proof of Lemma \ref{lemma:tauto}]~\\
...
\begin{proof}[Proof of Lemma \ref{lem:det2grad}]~
    \begin{description}
        \item[Introduction] 
        \begin{align*}
        &P(\phi_1, \phi_2) \\
...
\begin{proof}[Proof of Lemma \ref{lemma:runtime-checks-reduced}]~\\
...
\begin{proof}[Proof of Corollary \ref{cor:runtime-checks-removed}]~\\
    The condition of lemma \ref{lemma:runtime-checks-reduced} is directly implied.
\end{proof}

\begin{proof}[Proof of Lemma \ref{lemma:det-lift-comp}]~
    \begin{description}
        \item[Introduction]
        \begin{align*}
...
\begin{proof}[Proof of Lemma \ref{lemma:opt-lift-impl}]~
    \begin{description}
        \item[Soundness]
        \begin{description}
...
\begin{proof}[Proof of Lemma \ref{lemma:compl-sem}]~\\
...
\begin{proof}[Proof of Theorem \ref{thm:compl-and-so-to-gdpres}]~\\
...
\begin{proof}[Proof of Lemma \ref{lemma:gdpres-seq}]
    \begin{mathpar}
        \inferrule* [Right=seq]
        {
...
\begin{proof}[Proof of Lemma \ref{lemma:snd-svlidf}]
    Omitted (proof in \cite{olydisGitHub}).
\end{proof}

\begin{proof}[Proof of Lemma \ref{lemma:ss-wd}]~\\
...
\begin{proof}[Proof of Lemma \ref{lemma:gvlidf-sdl-hl}]~
    \begin{description}
...
\begin{proof}[Proof of Lemma \ref{lemma:gss-wd}]~\\
...
\begin{proof}[Proof of Lemma \ref{lemma:gss-sl}]
...
\begin{proof}[Proof of Lemma \ref{lemma:pc-idf}]~\\
    Goal:
    \begin{flalign*}
...
\begin{proof}[Proof of Lemma \ref{lemma:pso-idf}]~\\
...
\begin{proof}[Proof of Lemma \ref{lemma:is-decl}]~\\
    Assumption:
    \begin{align}
...
\begin{proof}[Proof of Lemma \ref{lemma:is-call}]~\\
    Assumption:
    \begin{align}
...
\begin{proof}[Proof of Lemma \ref{lemma:is-hold}]
    Analogous to previous proofs.
\end{proof}

\begin{proof}[Proof of Lemma \ref{lemma:is-seq}]
    Analogous to lemma \ref{lemma:gdpres-seq}.
\end{proof}

\begin{proof}[Proof of Theorem \ref{thm:gvlidf-dgsnd}]~\\
...
\begin{proof}[Proof of Lemma \ref{lemma:oh-free}]~\\
    We prove that 
    \begin{align}
    \begin{split}
    \label{frm:oh-free1}
...
\begin{proof}[Proof of Lemma \ref{lemma:gc-nonex}]~\\
...
\begin{proof}[Proofs of Lemma \ref{ex:idf-opt-lift-evalphi}, \ref{ex:idf-opt-lift-sfrmphi}, \ref{lemma:impl-gimpl}, \ref{lemma:frm-extr}, \ref{lemma:var-extr}]
    Omitted (proofs in \cite{olydisGitHub}).
\end{proof}

\begin{proof}[Proof of Theorem \ref{thm:gnf}]~\\
    Omitted.
...
\begin{proof}[Proof of Lemma \ref{lemma:mention}]~\\
