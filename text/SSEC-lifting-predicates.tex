...
\begin{definition}[Sound Predicate Lifting]
...
\begin{definition}[Optimal Predicate Lifting]
...
\begin{lemma}[Optimal Predicate Lifting (Direct Definition)]\label{lemma:consistent-pred-lifting-direct}
