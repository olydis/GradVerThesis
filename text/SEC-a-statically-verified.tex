...
\item[Program State]~\\
    ...
    Note how these examples use statements to represent “remaining work” of the program state, necessary for the operational semantics to deduce a state transition.
