...
\item[Dynamic Semantics]~\\
    ...
    As usual, taking $n$ steps is abbreviated as $\sstepGeneric{\cdot}{n}{\cdot}$ (undefinedness is propagated), taking any finite amount of steps is abbreviated as $\ssteps{\cdot}{\cdot}$.
