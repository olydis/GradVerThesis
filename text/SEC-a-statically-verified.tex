...
\item[Program State]
    ...
    This notion will be necessary to define soundness of \svl's static semantics means.
...
\item[Formula Semantics]~\\
    Formulas are used to describe program states. % more verbose? can be viewed as types?
