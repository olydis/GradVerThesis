...
In section \ref{sec:gradual-dyn--semantics} we derive gradual small-step semantics in a way that makes the gradual verification system sound and also complies with the stronger notion of soundness “\tset{\dgradT Soundness}” postulated in section \ref{ssec:gradual-soundness}.