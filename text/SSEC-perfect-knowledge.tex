...
\begin{proof}
    ...
    \label{frm:tmp14}
    \end{align}
    For the goal to hold we would require $\grad{\phi} \mpt \grad{\phi_2}$ which we will prove via case-analysis:
    
    
    Now, using monotonicity of deterministic liftings we can use (\phi_1 \mpt \grad{\phi_1}, see ) to derive
\end{proof}
