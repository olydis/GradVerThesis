\begin{definition}[Perfect Small-Step Semantics for Statement]~\\
    ...
    \begin{flalign*}
    & \forall \pi_1, \pi_2 \in \setProgramState.~ \sstepConsume{s}{\pi_1}{\pi_2} \implies \exists \phi_1, \phi_2 \in \setFormula.~ \thoare{}{\phi_1}{s}{\phi_2} \wedge \evalphiGen{\pi_1}{\phi_1} \wedge \evalphiGen{\pi_2}{\phi_2}
    \end{flalign*}
\end{definition}
