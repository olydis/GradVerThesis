...
\begin{description}
    ...
    The formula semantics introduced in section \ref{ssec:formula-semantics} will make sure that the separating conjunction is not violated, rendering above formulas unsatisfiable in any environment where \ttt{a} and \ttt{b} alias.
\end{description}
\begin{figure}[h]
