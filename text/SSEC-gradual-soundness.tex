...
& \gtHoare {~} {\grad{\phi_{pre}}} {\grad{s}} {\grad{\phi_{post}}} ~\defiff~ \forall \grad{\pi_{pre}}, \grad{\pi_{post}} \in \setGProgramState.~\\
&\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad~ \gsstepConsume{\grad{s}}{\grad{\pi_{pre}}}{\grad{\pi_{post}}} \implies (\evalgphiGen{\grad{\pi_{pre}}}{\grad{\phi_{pre}}} \implies \evalgphiGen{\grad{\pi_{post}}}{\grad{\phi_{post}}})
\end{flalign*}
