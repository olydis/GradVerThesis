...
\begin{mathpar}
    \inferrule* [Right=\gradT Progress]
    {
        ???
    }
    {
...
\end{mathpar}
\begin{mathpar}
    \inferrule* [Right=\gradT Preservation]
    {
...
\begin{lemma}[\tset{\gradT Preservation'} Tautology]
    \label{lemma:tauto}
    \tset{\gradT Preservation'} is a tautology. 
\end{lemma}
\begin{proof}~\\
...
That \tset{\gradT Preservation'} is a tautology makes sense, realizing that (without demanding any degree of optimality) $\gthoare{}{\cdot}{\cdot}{\cdot}$ carries zero information.
