...
As shown in section \ref{ssec:gradual-soundness}, \tset{\gradT Soundness} is a tautology, i.e. the gradual system we have derived is sound.

%% soundnessX
However, in case the deterministic lifting approach is used to derive a gradual Hoare logic it is desirable to satisfy the stronger notion of soundness “\tset{\dgradT Soundness}” introduced in section \ref{ssec:the-deterministic-approach} (definition \ref{def:dgsnd}).
