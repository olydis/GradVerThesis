...
When first introducing \tset{GDPreservation} in section \ref{ssec:the-deterministic-approach}, we also gave an example (\ref{ex:cex-gdpres}) illustrating that whether it holds or not can depend on the small-step semantics of \gvl.
