...
\begin{description}
    ...
    \begin{example}{Counterexample of Optimality Induced by Deterministic Lifting}
        ...
        Now, let $\setGFormula$ be extended suing the “dedicated wildcard” approach (see section \ref{ssec:dedicated-wildcard-formula}).
        ...
        Since $\gphiImplies{\qm}{\phiEq{x}{1}}$ holds, we can deduce
        \begin{displaymath}
        ...
        Note that with $\withqmGen{\phiEq{x}{3}}$ as a postcondition, one cannot deduce above above gradual judgment (since $\gphiImplies{\withqmGen{\phiEq{x}{3}}}{\phiEq{x}{1}}$) does not hold.
