...
% TODO: \Gamma & \in \setTypeEnv    &  & =~~ \setVar \rightharpoonup \setType
...
% TODO: Hoare logic ensures self-framing and prevents duplication (should be consequence of soundness)
