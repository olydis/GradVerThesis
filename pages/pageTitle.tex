\begin{titlepage}
    ...
    \begin{tikzpicture}[remember picture,overlay]
      ...
      {
        \begin{minipage}{6cm}
            \includegraphics[width=4cm]{logos/KIT}
            \begin{flushleft}
                \footnotesize{}
      ...
      {    
          \begin{minipage}{5cm}
              ...
              \includegraphics[width=5cm]{logos/cmu-flat}
              ~\\
              \includegraphics[width=5cm]{logos/ISR}
          \end{minipage}
      };
      ...
      \node (title) at ($(current page.center) + (0cm, 6cm)$)
      {
        ...
        \begin{minipage}{12cm}
          \begin{center}
            \huge\textbf{Gradual Verification \\ and maybe something about \\ implicit dynamic frames}
          \end{center}
        \end{minipage}
      };
      ...
      \node[below=1cm    of name.south]    (postname1) { at the Department of Informatics };
...
and Data Organization (IPD) };
      ...
      {
        \begin{tabular}{ll}
        \textbf{Reviewer:}               & Prof. Dr.-Ing. Gregor Snelting, Karlsruhe Institute of Technology - Karlsruhe, Germany \\[5pt]
        \textbf{Advisors:}               & Assoc. Prof. Jonathan Aldrich, Carnegie Mellon University - Pittsburgh, USA \\
      ...
      {
        \begin{tabular}{ll}
        \textbf{Duration:} & 2016-05-10 -- 2016-09-28
        \end{tabular}
      };
