...
%% decoration
\newcommand{\pa}[1]{${#1}^{\circ}$}
\newcommand{\pb}[1]{${#1}^{\checkmark}$}
...
\newcommand{\mbody}{\predicate{mbody$_p$}}
\newcommand{\mparam}{\predicate{mparam$_p$}}
\newcommand{\mrettype}{\predicate{mrettype$_p$}}
\newcommand{\mmethod}{\predicate{mmethod$_p$}}
% other
