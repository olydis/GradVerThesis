...
{
    {({H}, {{({{\rho'}, {A'}}, {\emptyset})} \cdot {{({{\rho}, {A}}, {{\sCall {${x}$} {${y}$} {${m}$} {${z}$}} {\overline{s}}})} \cdot {S}}})} \rightarrow {({H}, {{({{{\rho}[{x} \mapsto {v_r}]}, {{A} \cup {A''}}}, {\overline{s}})} \cdot {S}})}
}
\end{mathpar}
...
{
    {({H}, {{({{\rho'}, {A'}}, {\emptyset})} \cdot {{({{\rho}, {A}}, {{\sHold {${\phi}$} {${\overline{s'}}$}} {\overline{s}}})} \cdot {S}}})} \rightarrow {({H}, {{({{\rho'}, {{A} \cup {A'}}}, {\overline{s}})} \cdot {S}})}
}
\end{mathpar}
